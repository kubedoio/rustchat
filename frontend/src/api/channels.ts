...
export const channelsApi = {
  ...
  listJoinable: (teamId: string) =>
    api.get<Channel[]>('/channels', { params: { team_id: teamId, available_to_join: true } }),
  ...
  getMember: (channelId: string, userId: string) =>
    api.get<ChannelMember>(`/channels/${channelId}/members/${userId}`),
