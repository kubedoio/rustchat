...
export const playbooksApi = {
  ...
  create: (teamId: string, data: CreatePlaybookRequest) =>
    api.post<Playbook>('/playbooks', data, { params: { team_id: teamId } }),
  ...
  deleteChecklist: (playbookId: string, id: string) =>
    api.delete(`/playbooks/${playbookId}/checklists/${id}`),

  // Tasks
  createTask: (checklistId: string, data: Record<string, unknown>) =>
    api.post<PlaybookTask>(`/checklists/${checklistId}/tasks`, data),
  updateTask: (id: string, data: Record<string, unknown>) =>
    api.put<PlaybookTask>(`/tasks/${id}`, data),
  deleteTask: (id: string) => api.delete(`/tasks/${id}`),

  // Runs
  listRuns: (teamId: string) => api.get<PlaybookRun[]>('/runs', { params: { team_id: teamId } }),
  startRun: (teamId: string, data: StartRunRequest) =>
    api.post<RunWithTasks>('/runs', data, { params: { team_id: teamId } }),
