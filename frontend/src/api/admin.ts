...
export const adminApi = {
  ...
  // Teams & Channels
  listTeams: (params?: { page?: number; per_page?: number; search?: string }) =>
  ...
  createMailProvider: (data: CreateMailProviderRequest) =>
    api.post<MailProvider>('/admin/email/providers', data),
  updateMailProvider: (id: string, data: Partial<CreateMailProviderRequest>) =>
    api.put<MailProvider>(`/admin/email/providers/${id}`, data),
  deleteMailProvider: (id: string) => api.delete(`/admin/email/providers/${id}`),
  testMailProvider: (id: string, toEmail: string) =>
    api.post(`/admin/email/providers/${id}/test`, { to_email: toEmail }),
  ...
  updateCallsPluginConfig: (config: CallsPluginConfig) =>
    api.put<CallsPluginConfigResponse>('/admin/plugins/calls', config),
  ...
  updateSsoConfig: (id: string, data: UpdateSsoConfigRequest) =>
    api.put<SsoConfig>(`/admin/sso/${id}`, data),
