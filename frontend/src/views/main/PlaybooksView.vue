    ...
    <div class="flex-1 flex flex-col min-w-0 bg-gray-50">
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        >
          ...
          <div v-else key="runs">
            <div
              v-if="playbookStore.runs.length === 0"
              class="text-center py-20 bg-white rounded-lg border border-gray-200 border-dashed"
            >
            ...
            <div v-else class="grid grid-cols-1 gap-4">
              ...
              >
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <h3
                      class="font-medium text-gray-900 group-hover:text-primary transition-colors"
                    >
                      {{ run.name }}
                    </h3>
                    <div class="flex items-center space-x-2 mt-1 text-xs text-gray-500">
                      <span class="capitalize px-1.5 py-0.5 rounded bg-gray-100">{{
