...
<template>
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div v-if="loading" class="text-center py-8 text-gray-500">Loading providers...</div>
            ...
            <div>
              <div class="flex items-center gap-2">
                <span class="font-medium text-gray-900"
                  >{{ provider.host }}:{{ provider.port }}</span
                >
                <span
              ...
              <div class="text-sm text-gray-500">
                {{ provider.from_name }} &lt;{{ provider.from_address }}&gt; •
                {{ provider.tls_mode.toUpperCase() }}
              </div>
            </div>
          </div>
          <div class="flex items-center gap-2">
