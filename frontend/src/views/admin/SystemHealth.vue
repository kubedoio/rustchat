  ...
  <div class="space-y-6">
    ...
    <div v-if="adminStore.health" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="flex items-center justify-between mb-4">
          ...
          <span
            :class="[
              ...
              adminStore.health.status === 'healthy'
                ? 'bg-green-100 text-green-800'
                : adminStore.health.status === 'degraded'
      ...
      <div class="bg-white rounded-xl p-6 border border-gray-200">
        ...
        <p class="text-sm text-gray-500">
          ...
          <span class="font-medium text-gray-900"
            >{{ adminStore.health.database.latency_ms }}ms</span
          >
        </p>
      </div>
      ...
      <div class="bg-white rounded-xl p-6 border border-gray-200">
        ...
        <p class="text-sm text-gray-500">
          Latency:
          <span class="font-medium text-gray-900">{{ adminStore.health.redis.latency_ms }}ms</span>
        </p>
      </div>
      ...
      <div class="bg-white rounded-xl p-6 border border-gray-200">
        ...
        <p class="text-sm text-gray-500">
          Used:
          <span class="font-medium text-gray-900">{{ adminStore.health.disk.used_percent }}%</span>
        </p>
        <p class="text-sm text-gray-500">
          Available:
          <span class="font-medium text-gray-900"
            >{{ adminStore.health.disk.available_mb }} MB</span
          >
        </p>
      </div>
    </div>
