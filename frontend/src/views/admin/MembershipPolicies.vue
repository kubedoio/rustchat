          ...
          <div class="flex items-start justify-between">
            <div class="flex-1 min-w-0">
              <div class="flex items-center space-x-3">
                <component :is="getScopeIcon(policy.scope_type)" class="w-5 h-5 text-gray-400" />
              ...
              <div class="mt-3 flex flex-wrap items-center gap-4 text-sm text-gray-500">
                ...
                <span class="flex items-center"> Priority: {{ policy.priority }} </span>
              </div>
            </div>
    ...
    >
      <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[80vh] flex flex-col">
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 class="text-xl font-bold text-gray-900">Audit Log: {{ auditPolicy?.name }}</h2>
