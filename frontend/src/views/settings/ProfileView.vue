...
const fieldInputClass =
  'w-full rounded-lg border border-border-1 bg-bg-surface-2 px-4 py-2.5 text-text-1 outline-none transition-standard placeholder:text-text-3 focus:border-brand focus:ring-2 focus:ring-brand/15'
    ...
    <div class="mx-auto max-w-3xl space-y-8">
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          <router-link
            to="/"
            class="rounded-full p-2 text-text-3 transition-colors hover:bg-bg-surface-2 hover:text-text-1"
          >
          ...
          <div>
            ...
            <h1 class="text-[30px] font-semibold tracking-[-0.04em] text-text-1">
              Profile Settings
            </h1>
          </div>
        </div>
      ...
      <div class="overflow-hidden rounded-xl border border-border-1 bg-bg-surface-1 shadow-1">
        <div
          class="flex flex-col items-center border-b border-border-1 bg-[radial-gradient(circle_at_top,_color-mix(in_srgb,_var(--brand)_10%,transparent),transparent_55%)] p-8"
        >
          <div class="relative group">
            ...
            <div
              v-if="uploading"
              class="absolute inset-0 z-10 flex items-center justify-center rounded-full bg-black/60 text-white"
            >
              <div
          ...
          <div class="mt-5 text-center">
            <p class="text-lg font-semibold tracking-[-0.02em] text-text-1">
        ...
        <div class="space-y-6 p-8">
          <div
            v-if="error"
            class="rounded-lg border border-danger/20 bg-danger/10 p-4 text-sm text-danger"
          >
            {{ error }}
          </div>
          <div
            v-if="success"
            class="rounded-lg border border-success/20 bg-success/10 p-4 text-sm text-success"
          >
          ...
          <div class="grid grid-cols-1 gap-6">
            <section :class="sectionCardClass">
              <div class="mb-5 border-b border-border-1 pb-4">
                ...
                <p class="mt-1 text-sm text-text-3">
                  Update the personal details teammates see in channels, mentions, and profiles.
                </p>
              </div>
              ...
              <div class="grid grid-cols-1 gap-6">
                ...
                <div class="space-y-2">
                  ...
                  <div class="relative">
                    <span class="absolute left-4 top-1/2 -translate-y-1/2 font-medium text-text-3"
                      >@</span
                    >
                    <input v-model="username" type="text" :class="`${fieldInputClass} pl-9 pr-4`" />
                  </div>
                </div>
            ...
            <section :class="sectionCardClass">
              <div class="mb-5 border-b border-border-1 pb-4">
                ...
                <p class="mt-1 text-sm text-text-3">
                  Theme, typography, and sizing all apply live so you can check contrast as you go.
                </p>
              </div>
            ...
            <section :class="sectionCardClass">
              <div class="mb-5 border-b border-border-1 pb-4">
                ...
                <p class="mt-1 text-sm text-text-3">
                  Choose the reading tone and density that feels best for long chat sessions.
                </p>
              </div>
              ...
              <div class="space-y-5">
                ...
                <div class="space-y-2">
                  ...
                  <div class="grid grid-cols-3 gap-2 sm:grid-cols-5">
                    <label v-for="size in fontSizes" :key="size" class="cursor-pointer">
                      <input
