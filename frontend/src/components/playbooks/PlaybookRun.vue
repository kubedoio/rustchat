        ...
        <div class="flex items-center space-x-4 mb-4">
          ...
          <div>
            <div class="flex items-center space-x-2">
              ...
              <span
                class="px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 capitalize"
              >
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div class="flex-1">
                ...
                <p v-if="taskMap[task.task_id]?.description" class="text-sm text-gray-500 mt-0.5">
