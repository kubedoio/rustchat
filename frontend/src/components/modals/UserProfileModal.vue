...
const {
  ...
  isLoading: loading,
  error,
} = useUserSummary(() => (props.show ? props.userId : null))
      ...
      >
        ...
        <div v-else-if="user" class="pb-6">
          ...
          <div class="flex flex-col items-center px-6">
            ...
            <!-- Presence Badge -->
            <div
              data-testid="profile-modal-status"
            ...
            >
              <span
                ...
                :class="presenceMeta.badgeClass"
              >
                <component :is="presenceMeta.icon" class="h-3.5 w-3.5" />
                {{ presenceMeta.label }}
              </span>
              <span
                v-if="user.statusText"
          ...
          <div class="mt-6 space-y-4 px-6">
            ...
            <div
              ...
              class="flex items-center space-x-3 text-sm text-text-2"
            >
