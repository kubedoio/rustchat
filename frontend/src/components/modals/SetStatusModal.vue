...
<template>
  <Teleport to="body">
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <!-- Modal Panel -->
      <div
        class="relative bg-white rounded-lg shadow-xl w-full max-w-lg overflow-hidden transform transition-all"
      >
        <!-- Header -->
        ...
        <div class="p-6 space-y-4">
          ...
          <div>
            ...
            >
              <option v-for="opt in durations" :key="opt.value" :value="opt.value">
                {{ opt.label }}
              </option>
            </select>
          </div>
