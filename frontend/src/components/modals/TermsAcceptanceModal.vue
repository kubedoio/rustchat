    ...
    >
      ...
      >
        ...
        <div class="flex items-start gap-3 px-6 py-5 border-b border-border-1">
          ...
          <div
            class="px-2 py-1 bg-warning/10 text-warning text-[10px] rounded font-medium shrink-0"
          >
            Required
          </div>
        </div>
        ...
        <div
          v-if="error"
          class="mx-6 mt-4 flex items-center gap-2 p-3 bg-danger/10 border border-danger/20 rounded-lg text-danger text-xs"
        >
        ...
        <div class="px-6 py-5 border-t border-border-1 space-y-4">
          <label class="flex items-start gap-3 cursor-pointer">
            ...
            <span class="text-xs text-text-2">
              I have read and agree to the {{ terms.title }}. I understand that by accepting these
