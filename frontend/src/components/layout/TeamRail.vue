...
<template>
  <aside
    class="z-20 flex w-[var(--team-rail-width)] shrink-0 flex-col items-center border-r border-border-1 bg-bg-surface-2/95 py-3"
  >
    <div class="mb-3 text-[10px] font-semibold uppercase tracking-[0.22em] text-text-3">Teams</div>
    ...
    <div class="flex w-full flex-1 flex-col items-center gap-2 px-2">
      ...
      >
        ...
        <button
          ...
          :class="{
            ...
            'border border-border-1 bg-bg-surface-1 text-text-1 hover:-translate-y-0.5 hover:border-border-2 hover:text-brand hover:shadow-1':
      ...
      <div
        ...
        class="text-text-3 text-[10px] text-center px-2 uppercase font-bold tracking-tight mt-4"
      >
        No teams
      </div>
    </div>
