...
<template>
  <aside v-if="show" class="h-full bg-white flex flex-col">
    <!-- Header -->
      ...
      <div v-else class="divide-y divide-gray-100">
        ...
        >
          ...
          <div
            ...
            class="mt-2 text-[10px] text-blue-500 flex items-center"
          >
            <span class="mr-1"
              >{{ message.files.length }} attachment{{ message.files.length > 1 ? 's' : '' }}</span
            >
          </div>
        </div>
      </div>
