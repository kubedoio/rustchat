...
<template>
  <div
    ...
    :class="{ 'cursor-pointer hover:border-indigo-400': isImage(file.mime_type) }"
    @click="handlePreview"
  >
    <!-- Icon or Thumbnail -->
    <div
      class="relative aspect-video w-full rounded-lg overflow-hidden bg-gray-100 border border-gray-100"
    >
      <img
