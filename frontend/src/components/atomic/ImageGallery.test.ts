...
describe('ImageGallery', () => {
    const images = [
        { id: 'i1', name: 'a.jpg', url: 'https://example.com/a.jpg', thumbnail_url: 'https://example.com/a-thumb.jpg' },
        { id: 'i2', name: 'b.jpg', url: 'https://example.com/b.jpg', thumbnail_url: 'https://example.com/b-thumb.jpg' },
        { id: 'i3', name: 'c.jpg', url: 'https://example.com/c.jpg', thumbnail_url: 'https://example.com/c-thumb.jpg' },
    ]
