...
<template>
  ...
  >
    <div class="relative overflow-visible rounded-r-2 border border-border-1 bg-bg-surface-1 transition-standard focus-within:border-brand/60 focus-within:ring-2 focus-within:ring-brand/10">
      <!-- Formatting Toolbar -->
      <FormattingToolbar
        v-if="showToolbar"
